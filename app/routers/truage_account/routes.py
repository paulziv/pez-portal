...
account manager data logic when ready.
"""
...
<head>
  ...
  <title>TruAge Account Manager Report</title>
  <style>
...
<body>
  ...
  <h1>📋 TruAge Account Manager Report</h1>
...
async def status(user: UserClaims = Depends(_require)) -> dict:
    """Health / stub endpoint for the TruAge Account Manager app."""
